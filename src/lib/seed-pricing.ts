...
export function seedPricing() {
  const models = [
    ...
    { model_id: 'claude-opus-5.5', display_name: 'Claude Opus 5.5', provider: 'anthropic', input_price_per_1m: 4.00, cached_input_price_per_1m: 0.20, output_price_per_1m: 20.00, reasoning_price_per_1m: 0 },
    ...
    { model_id: 'gpt-6-astra', display_name: 'GPT-6 Astra', provider: 'openai', input_price_per_1m: 10.00, cached_input_price_per_1m: 1.00, output_price_per_1m: 50.00, reasoning_price_per_1m: 0 },
    { model_id: 'gpt-6-astra-pro', display_name: 'GPT-6 Astra Pro', provider: 'openai', input_price_per_1m: 10.00, cached_input_price_per_1m: 1.00, output_price_per_1m: 50.00, reasoning_price_per_1m: 0 },
    { model_id: 'gpt-6-sol', display_name: 'GPT-6 Sol', provider: 'openai', input_price_per_1m: 2.00, cached_input_price_per_1m: 0.20, output_price_per_1m: 10.00, reasoning_price_per_1m: 0 },
    { model_id: 'gpt-6-sol-pro', display_name: 'GPT-6 Sol Pro', provider: 'openai', input_price_per_1m: 2.00, cached_input_price_per_1m: 0.20, output_price_per_1m: 10.00, reasoning_price_per_1m: 0 },
    { model_id: 'gpt-6-luna', display_name: 'GPT-6 Luna', provider: 'openai', input_price_per_1m: 0.10, cached_input_price_per_1m: 0.01, output_price_per_1m: 0.50, reasoning_price_per_1m: 0 },
    { model_id: 'gpt-6-luna-pro', display_name: 'GPT-6 Luna Pro', provider: 'openai', input_price_per_1m: 0.10, cached_input_price_per_1m: 0.01, output_price_per_1m: 0.50, reasoning_price_per_1m: 0 },
    ...
    { model_id: 'grok-4.7', display_name: 'Grok 4.7', provider: 'xai', input_price_per_1m: 1.60, cached_input_price_per_1m: 0.40, output_price_per_1m: 4.80, reasoning_price_per_1m: 0 },
    ...
    { model_id: 'grok-bot-automation', display_name: 'Grok Bot Automation', provider: 'xai', input_price_per_1m: 2.00, cached_input_price_per_1m: 0.50, output_price_per_1m: 6.00, reasoning_price_per_1m: 0 },
    { model_id: 'grok-bot-cua', display_name: 'Grok Bot CUA', provider: 'xai', input_price_per_1m: 2.00, cached_input_price_per_1m: 0.50, output_price_per_1m: 6.00, reasoning_price_per_1m: 0 },

    // ─── 智谱 GLM / Z.ai ─── OpenRouter pricing
    { model_id: 'glm-5.3-prime', display_name: 'GLM-5.3 Prime', provider: 'zhipu', input_price_per_1m: 2.8000, cached_input_price_per_1m: 0.5600, output_price_per_1m: 8.8000, reasoning_price_per_1m: 0 },
    { model_id: 'glm-5.3-flashx', display_name: 'GLM-5.3 FlashX', provider: 'zhipu', input_price_per_1m: 0.3700, cached_input_price_per_1m: 0.0900, output_price_per_1m: 1.2500, reasoning_price_per_1m: 0 },
    { model_id: 'glm-5.3-flash', display_name: 'GLM-5.3 Flash', provider: 'zhipu', input_price_per_1m: 0.1500, cached_input_price_per_1m: 0.0500, output_price_per_1m: 0.5000, reasoning_price_per_1m: 0 },
    { model_id: 'glm-5.3', display_name: 'GLM-5.3', provider: 'zhipu', input_price_per_1m: 0.8400, cached_input_price_per_1m: 0.1560, output_price_per_1m: 2.6400, reasoning_price_per_1m: 0 },
    { model_id: 'glm-5.2', display_name: 'GLM-5.2', provider: 'zhipu', input_price_per_1m: 0.6496, cached_input_price_per_1m: 0.1206, output_price_per_1m: 2.0416, reasoning_price_per_1m: 0 },
    ...
    { model_id: 'kimi-k2.7-code', display_name: 'Kimi K2.7 Code', provider: 'moonshot', input_price_per_1m: 0.6562, cached_input_price_per_1m: 0.1800, output_price_per_1m: 3.3000, reasoning_price_per_1m: 0 },
    { model_id: 'kimi-code/kimi-for-coding', display_name: 'Kimi for Coding', provider: 'moonshot', input_price_per_1m: 0.6562, cached_input_price_per_1m: 0.1800, output_price_per_1m: 3.3000, reasoning_price_per_1m: 0 },
    { model_id: 'kimi-for-coding', display_name: 'Kimi for Coding', provider: 'moonshot', input_price_per_1m: 0.6562, cached_input_price_per_1m: 0.1800, output_price_per_1m: 3.3000, reasoning_price_per_1m: 0 },
    ...
    { model_id: 'deepseek-v4.1-flash', display_name: 'DeepSeek V4.1 Flash', provider: 'deepseek', input_price_per_1m: 0.1400, cached_input_price_per_1m: 0.0042, output_price_per_1m: 0.4200, reasoning_price_per_1m: 0 },
    { model_id: 'deepseek-v4-pro', display_name: 'DeepSeek V4 Pro', provider: 'deepseek', input_price_per_1m: 0.9396, cached_input_price_per_1m: 0.0783, output_price_per_1m: 1.8792, reasoning_price_per_1m: 0 },
    ...
    { model_id: 'qwen3.7-flash', display_name: 'Qwen3.7 Flash', provider: 'alibaba', input_price_per_1m: 0.0300, cached_input_price_per_1m: 0.0060, output_price_per_1m: 0.1300, reasoning_price_per_1m: 0 },
    ...
    { model_id: 'muse-glimmer-30b', display_name: 'Muse Glimmer 30B', provider: 'meta', input_price_per_1m: 0.3000, cached_input_price_per_1m: 0.0400, output_price_per_1m: 1.2000, reasoning_price_per_1m: 0 },
    ...
    // ─── Xiaomi / MiMo ─── OpenRouter pricing
    { model_id: 'mimo-v2.6-pro-ultraspeed', display_name: 'MiMo V2.6 Pro UltraSpeed', provider: 'mimo', input_price_per_1m: 4.3500, cached_input_price_per_1m: 0.0360, output_price_per_1m: 8.7000, reasoning_price_per_1m: 0 },
    { model_id: 'mimo-v2.6-pro', display_name: 'MiMo V2.6 Pro', provider: 'mimo', input_price_per_1m: 0.4350, cached_input_price_per_1m: 0.0036, output_price_per_1m: 0.8700, reasoning_price_per_1m: 0 },
    { model_id: 'mimo-v2.6-flash', display_name: 'MiMo V2.6 Flash', provider: 'mimo', input_price_per_1m: 0.1400, cached_input_price_per_1m: 0.0028, output_price_per_1m: 0.2800, reasoning_price_per_1m: 0 },
    { model_id: 'mimo-v2.5-pro', display_name: 'MiMo V2.5 Pro', provider: 'mimo', input_price_per_1m: 0.4350, cached_input_price_per_1m: 0.0036, output_price_per_1m: 0.8700, reasoning_price_per_1m: 0 },
    { model_id: 'mimo-v2.5', display_name: 'MiMo V2.5', provider: 'mimo', input_price_per_1m: 0.1400, cached_input_price_per_1m: 0.0028, output_price_per_1m: 0.2800, reasoning_price_per_1m: 0 },
  ]
