...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'stats.estimated': { zh: '含估算 {n}', en: 'incl. {n} est.' },
  ...
  'settings.pricing.title': { zh: '模型价格配置', en: 'Model Pricing Table' },
  'settings.pricing.subtitle': { zh: '费用按百万 Token 单价计算（$/1M Tokens）· 共 {n} 个模型', en: 'Prices per 1 million tokens ($/1M) · {n} models' },
  'settings.pricing.search': { zh: '搜索模型或供应商', en: 'Search model or provider' },
  'settings.pricing.allProviders': { zh: '全部供应商', en: 'All providers' },
  'settings.pricing.col.model': { zh: '模型', en: 'Model' },
  'settings.pricing.col.provider': { zh: '供应商', en: 'Provider' },
  'settings.pricing.col.input': { zh: '输入 ($/1M)', en: 'Input ($/1M)' },
  'settings.pricing.col.cached': { zh: '缓存 ($/1M)', en: 'Cached ($/1M)' },
  'settings.pricing.col.output': { zh: '输出 ($/1M)', en: 'Output ($/1M)' },
  'settings.pricing.col.action': { zh: '操作', en: 'Action' },
  'settings.pricing.edit': { zh: '编辑', en: 'Edit' },
  'settings.pricing.empty': { zh: '没有匹配的模型', en: 'No matching models' },
  'settings.pricing.page': { zh: '第 {page} / {pages} 页', en: 'Page {page} / {pages}' },
  'settings.pricing.prev': { zh: '上一页', en: 'Previous' },
  'settings.pricing.next': { zh: '下一页', en: 'Next' },
  'settings.pricing.range': { zh: '显示 {from}–{to}', en: 'Showing {from}–{to}' },
  ...
  'quota.status.geminiNoQuota': { zh: '已登录 · Antigravity 暂无额度窗口', en: 'Signed in · no Antigravity quota windows' },
  'quota.account.codexDefault': { zh: '个人账户', en: 'Personal' },
  'quota.account.geminiDefault': { zh: 'Antigravity', en: 'Antigravity' },
  ...
  'quota.error.gemini.not_configured': { zh: 'Antigravity CLI 未登录 · 请先运行 agy 完成 Google 登录', en: 'Antigravity CLI not logged in · run agy and sign in with Google first' },
  'quota.error.gemini.auth_error': { zh: 'Antigravity 登录已失效 · 请重新运行 agy 登录', en: 'Antigravity login expired · run agy and sign in again' },
  'quota.error.gemini.unsupported': { zh: 'Antigravity 已登录，但 /usage 没有返回可读取的额度窗口', en: 'Antigravity is signed in, but /usage returned no readable quota windows' },
  ...
  'quota.error.grok.auth': { zh: 'Grok 登录已过期 · 请重新运行 grok login --oauth', en: 'Grok login expired · run grok login --oauth again' },
  'quota.error.grok.auth_error': { zh: 'Grok 登录已过期 · 请重新运行 grok login --oauth', en: 'Grok login expired · run grok login --oauth again' },
